...
const AwardContent: IAwardProps[] = [
    {
		...
		Society's 2021 Hackathon and was awarded with the peoples choice award 
		as voted for by our competitors, for our project during the event`,
        delay: 100,
    },
    {
        image: 'https://res.cloudinary.com/djeukcxxb/image/upload/c_scale,w_500/v1610372947/BestProject_o9iw4f.webp',
    ...
    {
        image: 'https://res.cloudinary.com/djeukcxxb/image/upload/c_scale,w_500/v1610372948/PeoplesChoice_yr26nv.webp',
        title: 'Peoples Choice Award',
        subTitle: 'UQCS 2020 Hackathon',
        text: `Competed in the University of Queensland Computer 
		Society's 2020 Hackathon and was awarded with the peoples choice award 
		as voted for by our competitors, for our project during the event`,
        delay: 200,
    },
    {
        image: 'https://res.cloudinary.com/djeukcxxb/image/upload/c_scale,h_500/v1610372948/Deans_qrcfeh.webp',
